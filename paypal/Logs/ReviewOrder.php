...
Log::write("ReviewOrder:: paypalorder insert 44", "log");
...
if(!isset($_REQUEST['token'])) {
    ...
    /*	   $currencyCodeType= "USD";
           ...
           $desc = 'good product';       */
            ...
            $paymentType= "sale";
           $L_QTY0  = 1;
           $L_AMT0  = $_GET['total_fee'];
           $L_NAME0  = $_GET['subject'];
           $invnm =  $_GET['out_trade_no'];
           $sellerId = $_GET['extern_token'];
           $desc = $_GET['body'];
Log::write("ReviewOrder:: paypalorder insert 2", "log");
    //产生订单表数据
    require_once 'service/paypal_order.php';
    $paypalorder = new paypal_order();
    $paypalorder->insertOrderInfo($_GET);
    Log::write("ReviewOrder:: paypalorder insert", "log");
